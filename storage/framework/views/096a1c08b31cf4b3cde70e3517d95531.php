...
<div class="form-card">
    ...
    <div class="mb-4">
        <h5 class="form-title mb-1">
            <?php echo e(isset($produk) ? 'Edit Data Produk' : 'Tambah Produk Baru'); ?>

        </h5>

        <small class="text-muted">
            <?php echo e(isset($produk)
...
</script><?php /**PATH C:\laragon\www\POS_Milaa-main\resources\views/Produk/_form.blade.php ENDPATH**/ ?>